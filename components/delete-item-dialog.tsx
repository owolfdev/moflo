...
import { deleteExpenses } from "@/utils/supabase"
...
export function DeleteItemDialog({ expenseId }: DeleteItemDialogProps) {
  ...
  //       <button onClick={handleSignOut}>Delete Expense</button>
  //     </div>
  //   )
    ...
    <div>
      <Dialog>
        ...
        <DialogContent className="sm:max-w-[425px]">
          <DialogHeader>
            <DialogTitle>You are about to delete an expense!</DialogTitle>
            <DialogDescription>
